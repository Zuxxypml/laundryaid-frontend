...
const products = [
  ...
  },
  {
    type: "Premium",
    description:
      "Experience the best in fabric care — deep cleaning, ironing, starching, and professional garment treatment.",
    benefits: [
      "Washing",
      "Stain Removal",
      "Ironing",
  ...
  },
  {
    type: "Deluxe",
    description:
      "A great choice for a polished look. Enjoy clean, crisp, and fresh-smelling clothes with washing, ironing, stain removal, and starching.",
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        {products.map((item, index) => (
          ...
          >
            ...
            <div className="text-lg font-bold text-[#4B5563]">
              {item.amount}
            </div>
          </div>
        ))}
