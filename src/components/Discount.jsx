...
function Discount() {
  ...
  /> */}
        ...
        <p className="text-3xl font-bold text-white z-1000">BOOK US TODAY</p>
        <div className="text-xl  text-secondary text-center z-1">
          <p>To get 40% Off</p>
          <p>your first booking</p>
        </div>
        <div className="z-1">
          <Link className="font-bold text-white bg-gradient-to-r from-[#c85f0b] via-[#f97a1d] to-[#fb8c3b] p-2 text-center w-full rounded-lg">
            Book Us Now
          </Link>
        </div>
      </div>
